...
async function main() {
  ...
  const tableBtn = page.locator('[aria-label*="table"], [aria-label*="list"], [title*="table"], [title*="list"], button:has([data-lucide="layout-list"]), button:has(.lucide-layout-list)').first()
  ...
  // ── 3. Inventory gallery ─────────────────────────────────────────
  const galleryBtn = page.locator('[aria-label*="gallery"], [aria-label*="photo"], [title*="gallery"], button:has([data-lucide="images"]), button:has(.lucide-images)').first()
