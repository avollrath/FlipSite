...
export function KPICard({
 ...
 return (
 <article
 className={`relative min-h-[100px] overflow-hidden rounded-lg border border-border-base bg-card p-5 shadow-xl shadow-border-base/40 backdrop-blur transition hover:shadow-2xl ${
